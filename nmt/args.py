...
def get_args():
    ...
    parser.add_argument(
        "--dataset_yaml", type=str, default="nmt/config/dynamic_gcn.yaml", help=""
    )

    parser.add_argument("--word-emb-size", type=int, default=300, help="")
    parser.add_argument("--log-dir", type=str, default="nmt/log/")
    parser.add_argument("--checkpoint-save-path", type=str, default="nmt/save")
